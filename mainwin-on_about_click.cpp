...
void Mainwin::on_about_click() {
    ...
    dialog.set_program_name("Mav's Ice Cream Emporium by Indus Inc.");
    auto logo = Gdk::Pixbuf::create_from_file("logo.png");
    dialog.set_logo(logo);
    dialog.set_version("Beta Version");
    dialog.set_copyright("Copyright 2017");
    dialog.set_license_type(Gtk::License::LICENSE_GPL_3_0);
      std::vector< Glib::ustring > authors = {"Ashwin Babu,Shreyash Shrivastava"};
